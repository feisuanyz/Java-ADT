...
**技术文档**
-----------------------------------
- 社区版入口：请下载[Local客户端](https://main.feisuanyz.com:8080/flow-community/feisuanyz-local-engine.zip)，安装Local客户端操作指导，请参见(https://feisuanyz.com/support/helpCenter/ 全自动开发平台 / 快速入门 / 1本地客户端 / 1.1 安装本地客户端)
