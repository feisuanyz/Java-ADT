...
![8-19](https://www.feisuanyz.com/fsimage/alcj-image/picturerecognize/5_13.png)

##### 图8-19 查看执行结果

k）若测试用例的结果出现错误，可通过可视化日志双击查看各个组件的节点数据进行接口的调试，如图8-20所示：

![8-20](https://www.feisuanyz.com/fsimage/alcj-image/picturerecognize/5_14.png)

##### 图8-20 查看可视化日志

l）查看各个组件的节点数据，绿色的节点表示顺利通过，如图8-21所示：

![8-21](https://www.feisuanyz.com/fsimage/alcj-image/picturerecognize/5_15.png)
