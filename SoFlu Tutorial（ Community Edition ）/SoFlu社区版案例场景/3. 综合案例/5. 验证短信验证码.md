...
![5-27](https://www.feisuanyz.com/fsimage/alcj-image/verifymessage/verify_27.png)

##### 图5-27 判断验证码是否失效

![5-28](https://www.feisuanyz.com/fsimage/alcj-image/verifymessage/verify_28.png)

##### 图5-28 流转条件1

![5-29](https://www.feisuanyz.com/fsimage/alcj-image/verifymessage/verify_29.png)

##### 图5-29 填写数据1

![5-30](https://www.feisuanyz.com/fsimage/alcj-image/verifymessage/verify_30.png)

##### 图5-30 流转条件2

![5-31](https://www.feisuanyz.com/fsimage/alcj-image/verifymessage/verify_31.png)
...
![5-32](https://www.feisuanyz.com/fsimage/alcj-image/verifymessage/verify_32.png)

##### 图5-32 保存并退出

##### 5.1.6 提交并发布接口

![5-33](https://www.feisuanyz.com/fsimage/alcj-image/verifymessage/verify_33.png)
...
![5-34](https://www.feisuanyz.com/fsimage/alcj-image/verifymessage/verify_34.png)

##### 图5-34 使用测试用例

b）填写接收到的验证码及对应的手机号，并启用可视化日志（便于查看接口流程中的数据流转），再单击执行即可。

![5-35](https://www.feisuanyz.com/fsimage/alcj-image/verifymessage/verify_35.png)
...
![5-36](https://www.feisuanyz.com/fsimage/alcj-image/verifymessage/verify_36.png)

##### 图5-36 验证成功

验证码失效：

![5-37](https://www.feisuanyz.com/fsimage/alcj-image/verifymessage/verify_37.png)

##### 图5-37 验证码失效

验证失败：

![5-38](https://www.feisuanyz.com/fsimage/alcj-image/verifymessage/verify_38.png)

##### 图5-38 验证失败

d）若测试用例的结果出现错误，可通过可视化日志双击查看各个组件的节点数据进行接口的调试。

![5-39](https://www.feisuanyz.com/fsimage/alcj-image/verifymessage/verify_39.png)

##### 图5-39 查看可视化日志

![5-40](https://www.feisuanyz.com/fsimage/alcj-image/verifymessage/verify_40.png)

##### 图5-40 可视化日志

![5-41](https://www.feisuanyz.com/fsimage/alcj-image/verifymessage/verify_41.png)
