...
![1-51](https://www.feisuanyz.com/fsimage/zc-image/czzn_11_14_10.png)

##### 图1-51 嵌入式中间件配置2

![1-52](https://www.feisuanyz.com/fsimage/zc-image/zysl/czzn_11_14_11.png)
...
![1-53](https://www.feisuanyz.com/fsimage/zc-image/zysl/1.png)

##### 图1-53 添加加载项

b）新增路由中间件资源实例，如图1-54所示：

![1-54](https://www.feisuanyz.com/fsimage/zc-image/zysl/2.png)

##### 图1-54 新增加载项

c）编辑资源实例，填写` routeValue `的值，如图1-55所示：

![1-55](https://www.feisuanyz.com/fsimage/zc-image/zysl/9.png)
...
![1-56](https://www.feisuanyz.com/fsimage/zc-image/zysl/7.png)

##### 图1-56 填写完成点击提交

e）进入流程图编辑，以单SQL组件为例（分页SQL组件，多SQL组件使用同理），如图1-57所示：

![1-57](https://www.feisuanyz.com/fsimage/zc-image/zysl/10.png)

##### 图1-57 流程图编辑

f）单击配置路由资源实例名称，选择刚创建的路由中间件资源实例名称，如图1-58所示：

![1-58](https://www.feisuanyz.com/fsimage/zc-image/zysl/11.png)

##### 图1-58 配置路由资源实例名称

![1-59](https://www.feisuanyz.com/fsimage/zc-image/zysl/12.png)
...
![1-60](https://www.feisuanyz.com/fsimage/zc-image/zysl/13.png)

##### 图1-60 输入Key值

##### 说明：若未配置路由资源实例名称以及资源实例key值这两项内容，系统则根据SQL组选择的中间件执行，如图1-61所示。

![1-61](https://www.feisuanyz.com/fsimage/zc-image/zysl/14.png)

##### 图1-61 编辑SQL组

##### 说明：用户进行SQL在线调试时，可通过选择路由中间件，输入key值来使用对应的中间件查询SQL，如图1-62所示：

![1-62](https://www.feisuanyz.com/fsimage/zc-image/zysl/16.png)
