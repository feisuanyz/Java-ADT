...
a）进入平台功能模块界面，选择接口管理，进入接口管理页面，如图2-66所示：

![2-66](https://www.feisuanyz.com/fsimage/zc-image/jkgl/export_0.png)

##### 图2-66 选择接口管理

b）单击“新增接口模块”旁的三个点按钮，选择“导入接口”，如图2-67所示：

![2-67](https://www.feisuanyz.com/fsimage/zc-image/jkgl/export_3.png)

##### 图2-67 选择导入接口

c）系统显示导入接口页面，选择导入模块并设置是否覆盖原有接口，如图2-68所示：
...
![2-68](https://www.feisuanyz.com/fsimage/zc-image/jkgl/export_4.png)

##### 图2-68 接口导入设置

d）上传需导入的接口文件，再单击“导入”即可。若提示接口导入失败，相应版本号的组件不存在，则需加载对应组件后再试，如图2-69所示：

![2-69](https://www.feisuanyz.com/fsimage/zc-image/jkgl/export_5.png)

##### 图2-69 接口导入失败提示

##### 2.6.2 导出接口

a）单击“新增接口模块”旁的三个点按钮，选择“导出接口”，如图2-70所示：

![2-70](https://www.feisuanyz.com/fsimage/zc-image/jkgl/export_1.png)

##### 图2-70 选择导出接口

b）系统显示导出接口页面，输入导出文件名，选择需导出的接口，默认含模块一起导出（若导出时选择不包含模块，导入时会自动生成默认模块）,如图2-71所示：

![2-71](https://www.feisuanyz.com/fsimage/zc-image/jkgl/export_2.png)

##### 图2-71 导入接口文档快速创建接口页面
...
![2-72](https://www.feisuanyz.com/fsimage/zc-image/jkgl/api_1.png)

##### 图2-72 本地执行引擎的解压路径

![2-73](https://www.feisuanyz.com/fsimage/zc-image/jkgl/api_1_2.png)

##### 图2-73 application.yml文件添加内容

b）保存application.yml文件后，双击` startup.bat `启动项目部署服务，如图2-74所示：

![2-74](https://www.feisuanyz.com/fsimage/zc-image/jkgl/api_2.png)

##### 图2-74 本地执行引擎的解压路径

c）在浏览器地址栏中输入项目中异常接口的请求路径，回车执行，出现接口异常，如图2-75所示：

![2-75](https://www.feisuanyz.com/fsimage/zc-image/jkgl/api_3_2.png)

##### 图2-75 执行异常接口

##### 说明：异常接口的请求路径可在测试用例结果页面找到，但服务器地址和端口需要替换为当前启动本地执行引擎的服务器地址和端口，如图2-76所示：

![2-76](https://www.feisuanyz.com/fsimage/zc-image/jkgl/api_7.png)

##### 图2-76 测试用例结果页面

d）进入对应的项目，在地址栏中找到projectId，如图2-77所示：

![2-77](https://www.feisuanyz.com/fsimage/zc-image/jkgl/api_4.png)

##### 图2-77 获取项目Id

e）进入对应接口的流程图编辑页面，在地址栏中找到interfaceId，如图2-78所示：

![2-78](https://www.feisuanyz.com/fsimage/zc-image/jkgl/api_5.png)

##### 图2-78 获取项目Id

f）在浏览器地址栏中输入对应的API接口地址，回车即可看到接口的异常信息（即数据快照），如图2-79所示：

![2-79](https://www.feisuanyz.com/fsimage/zc-image/jkgl/api_6.png)
