...
![2-31](https://www.feisuanyz.com/fsimage/alcj-image/alsx_2_251.png)

##### 图2-31 保存接口流程图配置

p）回到模型页面，单击“提交”，提交接口流程图配置，如图2-32所示：

![2-32](https://www.feisuanyz.com/fsimage/alcj-image/alsx_2_25_2.png)
...
![2-33](https://www.feisuanyz.com/fsimage/alcj-image/alsx_2_26.png)

##### 图2-33 发布接口

s）选择“... > 测试用例”，测试接口，如图2-34所示：

![2-34](https://www.feisuanyz.com/fsimage/alcj-image/alsx_2_27.png)

##### 图2-34 测试接口

t）进入测试用例页面，勾选当前测试用例，单击“执行”，如图2-35所示：

![2-35](https://www.feisuanyz.com/fsimage/alcj-image/cj_2-23_img.png)

##### 图2-35 测试用例页面

u）页面下方弹出测试用例详情页面，单击“响应内容”，查看接口测试结果，如图2-36所示：

![2-36](https://www.feisuanyz.com/fsimage/alcj-image/cj_2-24_img.png)
