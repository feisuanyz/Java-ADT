...
![5-22](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_17.png)

##### 图5-22 填写接口基本信息

c2）配置接口入口参数

此处需分别配置Body参数和头部参数作为接口入参，来新增用户操作日志表。其中Body参数配置String类型的参数content作为日志内容、Integer类型的参数logType作为日志类型（数字表示：1增加2删除3修改4查询5导出6清除历史数据7备份数据库 8登录系统 9退出系统），如图5-23所示；头部参数配置String类型的userId作为用户账户编号，如图5-24所示：

![5-23](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_18.png)

##### 图5-23 配置Body参数

![5-24](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_19.png)
...
![5-25](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_20.png)

##### 图5-25 请求响应参数管理组件【获取IP】

![5-26](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_21.png)
...
![5-27](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_22.png)

##### 图5-27 子流程组件【操作日志子流程】

![5-28](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_23.png)

##### 图5-28 选择子流程

![5-29](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_24.png)

##### 图5-29 组件配置

c4-3）单SQL组件【查询用户操作日志表】：用于查询用户操作日志表，具体SQL内容如图5-30所示：

![5-30](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_25.png)

##### 图5-30 单SQL组件【查询用户操作日志表】

![5-31](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_26.png)

##### 图5-31 SQL内容

c4-4）输出结果组件：用于输出操作日志列表，引用单SQL组件【查询用户操作日志表】的执行结果即可，如图5-33所示：

![5-33](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_27.png)

##### 图5-33 输出结果组件

![5-34](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_28.png)

##### 图5-34 组件配置

c4-5）保存接口流程图，如图5-35所示：

![5-35](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_29.png)

##### 图5-35 保存并退出

c4-6）提交并发布接口，如图5-36所示：

![5-36](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_30.png)

##### 图5-36 提交并发布接口

d）测试用例

d1）对接口进行测试用例，检验接口实现的功能是否可以达到预期，如图5-37所示：

![5-37](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_31.png)

##### 图5-37 使用测试用例

d2）编辑测试用例，如图5-38所示：

![5-38](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_32.png)

##### 图5-38 编辑测试用例

d3）单击“头部参数”页签，录入用户账户编号，如图5-39所示；单击“Body参数”页签，录入日志类型、日志内容，如图5-40所示，最后启用可视化日志（便于查看接口流程中的数据流转），单击执行即可：

![5-39](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_33.png)

##### 图5-39 录入头部参数

![5-40](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_34.png)

##### 图5-40 录入Body参数

d4）查看测试用例的响应内容以及用户操作日志表中的记录是否成功新增，如图5-41、5-42所示：

![5-41](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_35.png)

##### 图5-41 测试用例响应结果

![5-42](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_36.png)

##### 图5-42 查看数据表记录

d5）若测试用例的响应内容出现错误或用户操作日志表中未新增记录，您可以通过双击查看可视化日志中各个组件的节点数据，对接口进行调试，如图5-42、图5-43所示：

![5-42](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_37.png)

##### 图5-42 查看可视化日志

![5-43](https://www.feisuanyz.com/fsimage/alcj-image/systemlog/5_38.png)
