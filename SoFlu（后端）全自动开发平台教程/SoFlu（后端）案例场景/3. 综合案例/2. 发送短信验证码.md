...
![2-42](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_42.png)

##### 图2-42 SQL内容

d5）使用互斥条件组件判断【当前手机号当天获取验证码的次数】是否小于【当天获取验证码次数上限】，若大于等于，说明今日已超过验证码发送次数限制，将输出发送失败信息；若小于，则继续以下流程。

![2-43](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_43.png)

##### 图2-43 判断逻辑

【当前手机号当天获取验证码的次数】大于等于【当天获取验证码次数上限】时：

![2-44](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_44.png)

##### 图2-44 流转条件

![2-45](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_45.png)

##### 图2-45 填写数据

【当前手机号当天获取验证码的次数】小于【当天获取验证码次数上限】时：

![2-46](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_46.png)

##### 图2-46 流转条件

d6）使用单函数组件生成短信验证码，此处使用的函数为获取范围内随机数函数getRandomByRange(Long rangeBegin,Long rangeEnd)，传入参数1000、10000用于获取四位数短信验证码。

![2-47](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_47.png)

##### 图2-47 生成验证码

![2-48](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_48.png)
...
![2-49](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_49.png)

##### 图2-49 为手机号加上【+86】标识

![2-50](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_50.png)
...
![2-51](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_51.png)

##### 图2-51 构建发送验证码信息请求参数

![2-52](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_52.png)

##### 图2-52 填写数据（记录1-记录4）

![2-53](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_53.png)

##### 图2-53 填写数据（记录5-记录10）

![2-54](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_54.png)

##### 图2-54 填写数据（记录11-记录14）

d8-2）使用单函数组件调用函数sendMessage(Map params)发送短信息，需传入上一步构造的请求参数。

![2-55](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_55.png)

##### 图2-55 发送验证码信息

![2-56](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_56.png)
...
![2-57](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_57.png)

##### 图2-57 构建修改短信表的请求参数

![2-58](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_58.png)

##### 图2-58 填写数据（记录1-记录4）

![2-59](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_59.png)

##### 图2-59 填写数据（记录5-记录8）

![2-60](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_60.png)

##### 图2-60 修改短信表

![2-61](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_61.png)

##### 图2-61 填写数据

![2-62](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_62.png)

##### 图2-62 SQL内容

d10）使用输出结果组件输出验证码发送成功信息。

![2-63](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_63.png)

##### 图2-63 输出验证码发送成功信息

![2-64](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_64.png)
...
![2-65](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_65.png)

##### 图2-65 保存并退出

##### 2.1.6 提交并发布接口

![2-66](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_66.png)
...
![2-67](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_67.png)

##### 图2-67 使用测试用例

b）填写接收验证码的手机号，并启用可视化日志（便于查看接口流程中的数据流转），再单击执行即可。

![2-68](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_68.png)

##### 图2-68 启用可视化日志

c）通过测试用例响应内容查看接口的执行结果，同时查看填写的接收验证码的手机号是否接收到验证码信息。

![2-69](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_69.png)

##### 图2-69 查看接口执行结果

![2-70](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_70.png)

##### 图2-70 验证码信息

d）若测试用例的结果出现错误或没收到验证码信息，可通过可视化日志双击查看各个组件的节点数据进行接口的调试。

![2-71](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_71.png)

##### 图2-71 查看可视化日志

![2-72](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_72.png)

##### 图2-72 可视化日志

![2-73](https://www.feisuanyz.com/fsimage/alcj-image/sendmessage/send_73.png)
